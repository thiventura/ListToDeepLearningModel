...
image_dir = os.path.join("dataset","augmented")
output_graph = os.path.join("training","") + "new_model.pb"
intermediate_output_graphs_dir = os.path.join("training","tmp","intermediate_graph")
intermediate_store_frequency = 0
output_labels = os.path.join("training","") + "new_labels.txt"
summaries_dir = os.path.join("training","tmp","training_summaries")
learning_rate = 0.01
...
model_dir = os.path.join("training","tmp","model")
bottleneck_dir = os.path.join("training","tmp","bottlenecks")
